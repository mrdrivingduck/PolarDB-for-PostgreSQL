...
extern void polar_forget_invalid_pages(RelFileLocator locator, ForkNumber forkno, BlockNumber minblkno);
extern void polar_forget_invalid_pages_db(Oid dbid);
